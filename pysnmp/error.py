...
class MalformedArgument(BEREngineError):
    """Malformed argument
    """
    pass
...
class TypeError(BEREngineError):
...
class UnderRun(BEREngineError):
    """Short BER data stream
    """
    pass

class BadValue(BEREngineError):
    """Bad ASN.1 object value
    """
    pass

class ProtocolError(BEREngineError):
    """Incorrect data type / layout in SNMP message
    """
    pass
...
class NoRequest (SNMPEngineError):
    """No SNMP request arrived before timeout
    """
    pass

class NoDestination (SNMPEngineError):
    """Message destination is not known
    """
    pass
